...
import { ArrowUpRight, Cpu, Shield, Car, Utensils, Trophy, Zap, RadioTower, Crosshair, Sparkles } from "lucide-react";
...
const domains = [
  ...
  {
    name: "XDERO.COM",
    tag: "AI / Web3 / Developer Platform",
    signal: "A bold, futuristic brand built for AI, blockchain, SaaS, cybersecurity, or next-generation developer tools. Short, memorable, and highly brandable, XDERO.COM has the premium feel of today's leading tech startups.",
    icon: Cpu,
    price: "Make Offer",
    intensity: 94,
  },
  ...
  },
  {
    name: "MUFTARIS.COM",
    tag: "Technology / SaaS",
    signal: "Distinctive, globally brandable name with a premium feel. Well suited for an AI startup, SaaS platform, fintech product, or next-generation technology company.",
    icon: Sparkles,
    price: "Make Offer",
    intensity: 90,
  },
                  ...
                  >
                    <div className="relative z-10 h-full rounded-[1.7rem] p-6">
                      ...
                      <div className="mt-8 flex items-center justify-between border-t border-slate-200 pt-5">
                        ...
                        <a
                          href={`https://www.atom.com/name/${encodeURIComponent(domain.name)}`}
